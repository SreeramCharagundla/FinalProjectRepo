 ...
 * @author pravallika
 */
public class Thalassemia_Centre_Coordinator_WorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form Thalassemia_Centre_Coordinator_WorkAreaJPanel
     * 
     */
    boolean a = true;
    private UserAccount userAccount;
    Thalassemia_Centre_Organization cirrhosisCentreOrganization;
    ...
    public Thalassemia_Centre_Coordinator_WorkAreaJPanel(UserAccount account,Thalassemia_Centre_Organization cirrhosisCentreOrganization, Enterprise enterprise, EcoSystem system, Network network) {
        initComponents();
        this.system = system;
    ...
    private void initComponents() {
        ...
        btnReceiveRequests.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnReceiveRequests.setForeground(new java.awt.Color(51, 51, 51));
        btnReceiveRequests.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnReceiveRequests.setText("Patient  Request");
        ...
        btnPatientStatus.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnPatientStatus.setForeground(new java.awt.Color(51, 51, 51));
        btnPatientStatus.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        btnPatientStatus.setText("Patient Status");
    ...
    private void btnProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnProfileMouseClicked
        ...
        ManageBloodCentreCoordinatorProfile manageCirrhosisCoordinatorWorkAreaJPanel = new ManageBloodCentreCoordinatorProfile(userAccount,cirrhosisCentreOrganization,enterprise);
