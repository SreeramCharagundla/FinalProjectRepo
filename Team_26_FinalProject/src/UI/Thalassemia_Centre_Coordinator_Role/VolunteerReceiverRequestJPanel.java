...
public class VolunteerReceiverRequestJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        digText = new javax.swing.JTextField();
        ...
        buttonApprove.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        digText.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        add(digText, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 430, 190, -1));

        jLabel11.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel11.setText("Thalassemia diagnosed date");
        ...
        jLabel25.setText("Patient Request");
        ...
        labConfirmationText.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        add(lblProfilePicture, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 310, 160, 140));
        ...
        add(diagnosedDateChooser, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 620, 170, -1));
        ...
        jLabel4.setText("Disease History Details");
    ...
    private void buttonApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonApproveActionPerformed
        ...
        try {
            patient.getDIG().updateDIGlist(digText.getText());
        }
        catch (Exception e) {
            JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Patient's Blood Type can only be one of these A,B,AB,O</b></html>"));
            return;
        }
        ...
        for (Enterprise enterprise : network.getEnterprise_Directory().getEnterpriseList()) {
            if (enterprise.getEnterpriseType().toString().equals("Insurance")) {
        ...
        if (org != null) {
            ...
            request.setAssigned("Insurance Department");
            request.setSummary("Requested for Blood Bank Reception");
            request.setStatus("Assigned to Insurance Department");
    ...
    private javax.swing.JTextField digText;
    ...
    private void populateRequestDetails(PatientRequest patientRequest) {
            ...
            diagnosedDateChooser.setDate(patientRequest.getCirrhosisDiagnosedDate());
            ageText.setText(String.valueOf(patientRequest.getAge()));
            genderText.setText(patientRequest.getGender());
            digText.setText(String.join(", ", (Iterable<String>) patientRequest.getDig().getDigValuesList()));
