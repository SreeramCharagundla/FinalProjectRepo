...
public class DonorListJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblDonors.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tblDonors.setForeground(new java.awt.Color(51, 51, 51));
        ...
        tblHospital.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        tblAssignment.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        ...
        jLabel25.setText("Assign Donor to a Hospital");
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (row < 0) {
            ...
            if(request.getDonor().getStatus().equals("Blood Collected"))
            {
