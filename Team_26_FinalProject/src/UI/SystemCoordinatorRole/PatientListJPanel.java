...
//            row[5] = request.getPatient().isEmergencyStatus();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Patients In Need For Blood Transfusion ");
        ...
        tblHospital.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tblHospital.setForeground(new java.awt.Color(51, 51, 51));
        ...
        tblAssignment.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        tblAssignment.setForeground(new java.awt.Color(51, 51, 51));
        ...
        jLabel25.setText("Assign Patient to a Hospital");
    ...
    private void btnAssignActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAssignActionPerformed
        ...
        if (row1 < 0) {
            ...
            if(request.getStatus().equals("BloodBank Approved. Passing to System Coordinator")){
