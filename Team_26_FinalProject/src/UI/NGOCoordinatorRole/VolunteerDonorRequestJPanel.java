...
public class VolunteerDonorRequestJPanel extends javax.swing.JPanel {
  ...
  //private DonorRequest donorRequest;
    ...
    private void populateRequestDetails(DonorRequest donorRequest){
            ...
            digTypesTextField.setText(String.join(", ",donorRequest.getDIG().getDigValuesList()));
            ...
            digTypesTextField.setEditable(false);
    ...
    private void btnApproveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveActionPerformed
        ...
        if( !statusText.getText().equals("New Request"))
        {
         ...
         JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Request can not be processed!</b></html>"), "Warning", JOptionPane.WARNING_MESSAGE);
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Patient's Blood Type can only be A, B, AB, O</b></html>"));
            return;
        }
        ...
        donor.setStatus("Blood Collected"); // status
        ...
        for(DonorRequest donorRequest: system.getDonorRequestDirectory().getDonorRequestList()){            
            ...
            donorRequest.setStatus("Blood Collected");
            dB4OUtil.storeSystem(system);
            }
        }
        statusText.setText("Blood Collected");
        
        dB4OUtil.storeSystem(system);
        populateRequestTable();
         JOptionPane.showMessageDialog(null, new JLabel(  "<html><b>Request processed successfully!</b></html>"));
