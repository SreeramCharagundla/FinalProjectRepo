...
public class NGOCoordinatorWorkAreaJPanel extends javax.swing.JPanel {

    /**
     * Creates new form NGOCoordinatorWorkAreaJPanel
     */
    
    private UserAccount userAccount;
    private NGOOrganization govtorganization;
    boolean a = true;
    DoctorOrganization doctorOrganization;
    private Enterprise enterprise;
    private EcoSystem system;
    private DB4OUtil dB4OUtil = DB4OUtil.getInstance();
    public NGOCoordinatorWorkAreaJPanel(UserAccount account, NGOOrganization govtorganization, Enterprise enterprise, EcoSystem business, Network network) {
        initComponents();
        this.system = system;
    ...
    private void BtnSelfProfileMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_BtnSelfProfileMouseClicked
        ...
        ManageNGOCoordinatorProfile manageGovtCoordinatorProfile = new ManageNGOCoordinatorProfile(userAccount,govtorganization,enterprise);
