...
public class AnalyticsJPanel extends javax.swing.JPanel {
    ...
    private void imgPieMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_imgPieMouseClicked
        ...
        pieDataset.setValue("Thalassemia Blood Donor", system.getDonorDirectory().getDonorList().size());
        pieDataset.setValue("Thalassemia Patient", system.getPatientDirectory().getPatientList().size());
...
//        linechartdata.setValue(7, "No. Of Work Request","Day3");
        linechartdata.setValue(system.getDonorDirectory().getDonorList().size(),"Patients/Donors","Thalassemia Blood Donor");
        linechartdata.setValue(system.getPatientDirectory().getPatientList().size(),"Patients/Donors","Thalassemia Patient");
...
//        barchartdata.setValue(7, "No. Of Work Request","Day3");
        barchartdata.setValue(system.getDonorDirectory().getDonorList().size(),"Patients/Donors","Thalassemia Blood Donor");
        barchartdata.setValue(system.getPatientDirectory().getPatientList().size(),"Patients/Donors","Thalassemia Patient");
...
//        barchartdata.setValue(7, "No. Of Work Request","Day3");
        barchartdata.setValue(system.getDonorDirectory().getDonorList().size(),"Patients/Donors","Thalassemia Blood Donor");
        barchartdata.setValue(system.getPatientDirectory().getPatientList().size(),"Patients/Donors","Thalassemia Patient(Receiver)");
        JFreeChart barchart = ChartFactory.createBarChart3D("Requests", "Patients/Donors", "Patients/Donors", barchartdata, PlotOrientation.VERTICAL, false, true, false);
        CategoryPlot barchrt = barchart.getCategoryPlot();
        barchrt.setRangeGridlinePaint(Color.ORANGE);
        ChartFrame chrtframe = new ChartFrame("Contribution", barchart, true);
